<?php
class clsincFooter { //incFooter class @1-31BF3ED2
...
//Class_Initialize Event @1-DF749EF4
    function clsincFooter($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "incFooter.php";
        $this->Redirect = "";
        $this->TemplateFileName = "incFooter.html";
...
} //End incFooter Class @1-FCB6E20C
