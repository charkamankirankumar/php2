<?php
//Include Common Files @1-1916D7E0
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "LAForm2.php");
...
//Include events file @1-35A4D6E6
include_once("./LAForm2_events.php");
