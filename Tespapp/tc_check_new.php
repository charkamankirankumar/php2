<?php
//Include Common Files @1-9BD6B591
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "tc_check_new.php");
...
//Open Method @2-FC3D9198
    function Open()
    {
        ...
        $this->SQL = "SELECT hv_route, mfi_hvf1_relogin_hv_no, mfi_hvf1_existing_enrollment_no, mfi_hvf1_customer_name, mfi_hvf1_customer_father_name, mfi_hvf1_customer_husband_name,\n\n" .
        "mfi_hvf1_customer_age_years, mfi_hvf1_husband_age_years, mfi_hvf1_customer_kyc_id_type, mfi_hvf1_customer_kyc_id_no, mfi_hvf1_husband_kyc_id_type,\n\n" .
        "mfi_hvf1_husband_kyc_id_no, mfi_hvf1_customer_current_address1, mfi_hvf1_customer_pin_code, mfi_hvf1_customer_mobile_no,\n\n" .
        "mfi_hvf1_husband_mobile_no, mfi_hvf1_customer_nature_of_residence, mfi_hvf1_customer_residence_years, mfi_hvf1_customer_marital_status,\n\n" .
        "mfi_hvf1_customer_religion, mfi_hvf1_caste, mfi_hvf1_customer_education, household_children, household_adults, household_total_members,\n\n" .
        "mfi_hvf1_customer_occupation, mfi_hvf1_customer_guarantor_occupation, mfi_hvf1_agricultureland, mfi_hvf1_no_of_crops, mfi_hvf1_total_milk_selling,\n\n" .
        "mfi_hvf1_auto_rickshaw, mfi_hvf1_barber_shop, mfi_hvf1_cuttleri_cloth, mfi_hvf1_cycle_repair, mfi_hvf1_daily_labour, mfi_hvf1_daily_labour_nos,\n\n" .
        "mfi_hvf1_fruit_vegetables, mfi_hvf1_provision_grocery, mfi_hvf1_skilled_labour, mfi_hvf1_tailoring_shop, mfi_hvf1_tea_fastfood,\n\n" .
        "mfi_hvf1_other_income_activity, mfi_hvf1_other_income_details, mfi_hvf1_customer_livestock_details_cows, mfi_hvf1_customer_livestock_details_buffalos,\n\n" .
        "mfi_hvf1_customer_livestock_details_goats_sheep, mfi_hvf1_customer_livestock_details_pigs, mfi_hvf1_customer_livestock_details_bullocks_ox,\n\n" .
        "mfi_hvf1_customer_livestock_details_chicken, mfi_hvf1_customer_house_type, mfi_hvf1_customer_vehicles_cycle_cart, mfi_hvf1_customer_vehicles_two_wheeler,\n\n" .
        "mfi_hvf1_customer_vehicles_auto_or_tempo, mfi_hvf1_customer_vehicles_tractor, mfi_hvf1_customer_vehicles_bullock_cart, monthly_household_income,\n\n" .
        "mfi_hvf1_financial_inclusion_loans, mfi_hvf1_financial_inclusion_bank_account, mfi_hvf1_financial_inclusion_insurance, mfi_hvf1_financial_inclusion_chits,\n\n" .
        "mfi_hvf1_financial_inclusion_micro_rimittances, mfi_hvf1_financial_inclusion_others, mfi_hvf1_financial_inclusion_others_specify,\n\n" .
        "mfi_hvf1_added_by, mfi_hvf1_added_at, mfi_hvf1_updated_by, mfi_hvf1_updated_at, mfi_hvf1.error_cols AS mfi_hvf1_error_cols,\n\n" .
        "mfi_hvf1.gp_id AS mfi_hvf1_gp_id, mfi_hvf2_rural_urban, mfi_cp_centre_name, cp_id, mfi_gp_proposed_group_name, mfi_hvf2_group_size,\n\n" .
        ...
        "mfi_telecaller_status, final_result, sanctioned_date, product, tdb_date, reason_rejection, cb_added, update_reason, tracker_download_date,\n\n" .
        "himark_raised_at, responce_received_at, last_called_at, mfi_hvf2.error_cols AS mfi_hvf2_error_cols, cb_added_at, mfi_hvf2.gp_id AS mfi_hvf2_gp_id,\n\n" .
        "mfi_hvf1.la_id AS mfi_hvf1_la_id, mfi_hvf2.la_id AS mfi_hvf2_la_id \n\n" .
        "FROM mfi_hvf1 INNER JOIN mfi_hvf2 ON\n\n" .
...
//Class_Initialize Event @567-47730C85
    function clsRecordmfi_tc_individualcheck($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->mfi_tc_1_ans = new clsControl(ccsTextBox, "mfi_tc_1_ans", $CCSLocales->GetText("mfi_tc_b1_ans"), ccsText, "", CCGetRequestParam("mfi_tc_1_ans", $Method, NULL), $this);
            $this->mfi_tc_2_ans = new clsControl(ccsTextBox, "mfi_tc_2_ans", $CCSLocales->GetText("mfi_tc_b2_ans"), ccsText, "", CCGetRequestParam("mfi_tc_2_ans", $Method, NULL), $this);
            $this->mfi_tc_3_ans = new clsControl(ccsTextBox, "mfi_tc_3_ans", $CCSLocales->GetText("mfi_tc_b3_ans"), ccsText, "", CCGetRequestParam("mfi_tc_3_ans", $Method, NULL), $this);
            $this->mfi_tc_4_ans = new clsControl(ccsTextBox, "mfi_tc_4_ans", $CCSLocales->GetText("mfi_tc_b4_ans"), ccsText, "", CCGetRequestParam("mfi_tc_4_ans", $Method, NULL), $this);
            $this->mfi_tc_5_ans = new clsControl(ccsTextBox, "mfi_tc_5_ans", $CCSLocales->GetText("mfi_tc_b5_ans"), ccsText, "", CCGetRequestParam("mfi_tc_5_ans", $Method, NULL), $this);
            $this->mfi_tc_6_ans = new clsControl(ccsTextBox, "mfi_tc_6_ans", $CCSLocales->GetText("mfi_tc_1_ans"), ccsText, "", CCGetRequestParam("mfi_tc_6_ans", $Method, NULL), $this);
            $this->mfi_tc_7_ans = new clsControl(ccsTextBox, "mfi_tc_7_ans", $CCSLocales->GetText("mfi_tc_2_ans"), ccsText, "", CCGetRequestParam("mfi_tc_7_ans", $Method, NULL), $this);
            $this->mfi_tc_8_ans = new clsControl(ccsTextBox, "mfi_tc_8_ans", $CCSLocales->GetText("mfi_tc_3_ans"), ccsText, "", CCGetRequestParam("mfi_tc_8_ans", $Method, NULL), $this);
            $this->mfi_tc_8_1_ans = new clsControl(ccsTextBox, "mfi_tc_8_1_ans", $CCSLocales->GetText("mfi_tc_4_ans"), ccsText, "", CCGetRequestParam("mfi_tc_8_1_ans", $Method, NULL), $this);
            $this->mfi_tc_9_ans = new clsControl(ccsTextBox, "mfi_tc_9_ans", $CCSLocales->GetText("mfi_tc_5_ans"), ccsText, "", CCGetRequestParam("mfi_tc_9_ans", $Method, NULL), $this);
            $this->mfi_tc_10_ans = new clsControl(ccsTextBox, "mfi_tc_10_ans", $CCSLocales->GetText("mfi_tc_6_ans"), ccsText, "", CCGetRequestParam("mfi_tc_10_ans", $Method, NULL), $this);
            ...
            $this->called_at = new clsControl(ccsTextBox, "called_at", $CCSLocales->GetText("called_at"), ccsDate, $DefaultDateFormat, CCGetRequestParam("called_at", $Method, NULL), $this);
            ...
            $this->tc_individual_check_status->Values = array(array("SANCTIONED", "SANCTIONED"), array("PENDING", "PENDING"), array("REJECTED", "REJECTED"));
            ...
            $this->mfi_tc_11_ans = new clsControl(ccsHidden, "mfi_tc_11_ans", "mfi_tc_11_ans", ccsText, "", CCGetRequestParam("mfi_tc_11_ans", $Method, NULL), $this);
            $this->mfi_tc_11_1_ans = new clsControl(ccsHidden, "mfi_tc_11_1_ans", "mfi_tc_11_1_ans", ccsText, "", CCGetRequestParam("mfi_tc_11_1_ans", $Method, NULL), $this);
            $this->mfi_tc_12_ans = new clsControl(ccsHidden, "mfi_tc_12_ans", "mfi_tc_12_ans", ccsText, "", CCGetRequestParam("mfi_tc_12_ans", $Method, NULL), $this);
            $this->mfi_tc_13_ans = new clsControl(ccsHidden, "mfi_tc_13_ans", "mfi_tc_13_ans", ccsText, "", CCGetRequestParam("mfi_tc_13_ans", $Method, NULL), $this);
        }
    }
//End Class_Initialize Event
...
//Validate Method @567-4ABDB836
    function Validate()
    {
        ...
        $Validation = ($this->mfi_tc_8_1_ans->Validate() && $Validation);
        ...
        $Validation = ($this->mfi_tc_11_1_ans->Validate() && $Validation);
        $Validation = ($this->mfi_tc_12_ans->Validate() && $Validation);
        $Validation = ($this->mfi_tc_13_ans->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->mfi_tc_8_1_ans->Errors->Count() == 0);
        ...
        $Validation =  $Validation && ($this->mfi_tc_11_1_ans->Errors->Count() == 0);
        $Validation =  $Validation && ($this->mfi_tc_12_ans->Errors->Count() == 0);
        $Validation =  $Validation && ($this->mfi_tc_13_ans->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @567-7ED32801
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->mfi_tc_8_1_ans->Errors->Count());
        ...
        $errors = ($errors || $this->mfi_tc_11_1_ans->Errors->Count());
        $errors = ($errors || $this->mfi_tc_12_ans->Errors->Count());
        $errors = ($errors || $this->mfi_tc_13_ans->Errors->Count());
...
//InsertRow Method @567-77029C37
    function InsertRow()
    {
        ...
        $this->DataSource->mfi_tc_8_1_ans->SetValue($this->mfi_tc_8_1_ans->GetValue(true));
        ...
        $this->DataSource->mfi_tc_11_1_ans->SetValue($this->mfi_tc_11_1_ans->GetValue(true));
        $this->DataSource->mfi_tc_12_ans->SetValue($this->mfi_tc_12_ans->GetValue(true));
        $this->DataSource->mfi_tc_13_ans->SetValue($this->mfi_tc_13_ans->GetValue(true));
...
//Show Method @567-0D4E9398
    function Show()
    {
        ...
        if($this->EditMode) {
            ...
            if($this->DataSource->Errors->Count() == 0 && $this->DataSource->next_record()) {
                ...
                if(!$this->FormSubmitted){
                    ...
                    $this->mfi_tc_8_1_ans->SetValue($this->DataSource->mfi_tc_8_1_ans->GetValue());
                    ...
                    $this->mfi_tc_11_1_ans->SetValue($this->DataSource->mfi_tc_11_1_ans->GetValue());
                    $this->mfi_tc_12_ans->SetValue($this->DataSource->mfi_tc_12_ans->GetValue());
                    $this->mfi_tc_13_ans->SetValue($this->DataSource->mfi_tc_13_ans->GetValue());
                }
            } else {
                $this->EditMode = false;
            }
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->mfi_tc_8_1_ans->Errors->ToString());
            ...
            $Error = ComposeStrings($Error, $this->mfi_tc_11_1_ans->Errors->ToString());
            $Error = ComposeStrings($Error, $this->mfi_tc_12_ans->Errors->ToString());
            $Error = ComposeStrings($Error, $this->mfi_tc_13_ans->Errors->ToString());
        ...
        $this->mfi_tc_11_1_ans->Show();
        $this->mfi_tc_12_ans->Show();
        $this->mfi_tc_13_ans->Show();
        $Tpl->parse();
        $Tpl->block_path = $ParentPath;
        $this->DataSource->close();
    }
...
//DataSource Variables @567-75E55EB9
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
    ...
    public $mfi_tc_11_1_ans;
    public $mfi_tc_12_ans;
    public $mfi_tc_13_ans;
//End DataSource Variables

//DataSourceClass_Initialize Event @567-399DBC26
    function clsmfi_tc_individualcheckDataSource(& $Parent)
    {
        ...
        $this->mfi_tc_8_1_ans = new clsField("mfi_tc_8_1_ans", ccsText, "");
        ...
        $this->mfi_tc_11_1_ans = new clsField("mfi_tc_11_1_ans", ccsText, "");
        
        $this->mfi_tc_12_ans = new clsField("mfi_tc_12_ans", ccsText, "");
        
        $this->mfi_tc_13_ans = new clsField("mfi_tc_13_ans", ccsText, "");
        ...
        $this->InsertFields["mfi_tc_11_1_ans"] = array("Name" => "mfi_tc_11_1_ans", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["mfi_tc_11_2_ans"] = array("Name" => "mfi_tc_11_2_ans", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["mfi_tc_12_ans"] = array("Name" => "mfi_tc_12_ans", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["mfi_tc_13_ans"] = array("Name" => "mfi_tc_13_ans", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
    }
//End DataSourceClass_Initialize Event
...
//SetValues Method @567-8C61AC1F
    function SetValues()
    {
        ...
        $this->mfi_tc_8_ans->SetDBValue($this->f("mfi_tc_8_1_ans"));
        $this->mfi_tc_8_1_ans->SetDBValue($this->f("mfi_tc_8_2_ans"));
        ...
        $this->mfi_tc_11_ans->SetDBValue($this->f("mfi_tc_11_1_ans"));
        $this->mfi_tc_11_1_ans->SetDBValue($this->f("mfi_tc_11_2_ans"));
        $this->mfi_tc_12_ans->SetDBValue($this->f("mfi_tc_12_ans"));
        $this->mfi_tc_13_ans->SetDBValue($this->f("mfi_tc_13_ans"));
    }
//End SetValues Method

//Insert Method @567-D2DC0750
    function Insert()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->InsertFields["mfi_tc_8_1_ans"]["Value"] = $this->mfi_tc_8_ans->GetDBValue(true);
        $this->InsertFields["mfi_tc_8_2_ans"]["Value"] = $this->mfi_tc_8_1_ans->GetDBValue(true);
        ...
        $this->InsertFields["mfi_tc_11_1_ans"]["Value"] = $this->mfi_tc_11_ans->GetDBValue(true);
        $this->InsertFields["mfi_tc_11_2_ans"]["Value"] = $this->mfi_tc_11_1_ans->GetDBValue(true);
        $this->InsertFields["mfi_tc_12_ans"]["Value"] = $this->mfi_tc_12_ans->GetDBValue(true);
        $this->InsertFields["mfi_tc_13_ans"]["Value"] = $this->mfi_tc_13_ans->GetDBValue(true);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "tc_check_new.html";
$BlockToParse = "main";
...
//Include events file @1-A18ECDB8
include_once("./tc_check_new_events.php");
