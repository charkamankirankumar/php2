...
//Page_BeforeInitialize @1-01167B41
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $userHomeRegion; //Compatibility
...
//Page_AfterInitialize @1-75BF1FE2
