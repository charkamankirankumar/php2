<?php
//Include Common Files @1-A92001CF
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "ChangeRegionBatchdedup.php");
...
//Class_Initialize Event @7-841E551E
...
//Open Method @7-A8BDB7FA
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT * \n\n" .
        "FROM batch_details_dedup {SQL_Where} {SQL_OrderBy}";
...
//Insert Method @7-A3EECCEB
    function Insert()
    {
        ...
        $this->SQL = CCBuildInsert("batch_details_dedup", $this->InsertFields, $this);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "ChangeRegionBatchdedup.html";
$BlockToParse = "main";
...
//Include events file @1-4769C74B
include_once("./ChangeRegionBatchdedup_events.php");
