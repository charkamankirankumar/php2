<?php
//Include Common Files @1-132E4D2A
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "manageFileUpload.php");
...
//Class_Initialize Event @15-B4EBD84E
    function clsGridmfi_fileupload($RelativePath, & $Parent)
    {
        ...
        $this->mfi_territorycode->Page = "manageFileUpload.php";
        ...
        $this->mfi_fileupload_Insert->Page = "manageFileUpload.php";
...
//Operation Method @16-9611403C
    function Operation()
    {
        ...
        $Redirect = "manageFileUpload.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "manageFileUpload.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "manageFileUpload.html";
$BlockToParse = "main";
...
//Include events file @1-57305348
include_once("./manageFileUpload_events.php");
