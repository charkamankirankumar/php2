...
function drawCaptcha(id, url, bColor, fColor)
{
    new Ajax.Request(url, {
        method: "get",
        requestHeaders: ['If-Modified-Since', "Thu Jan 01 1970 00:00:00 GMT+0000"],
        onSuccess: function (transport) {
            var bp = new qPaths();
            bp.load(transport.responseText.replace(/\r/g, "").replace(/\n/g, "").replace(/\s*/g, ""));
