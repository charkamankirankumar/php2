<?php
//Include Common Files @1-3F4163A3
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "tc_check_new_TMP1.php");
...
//Class_Initialize Event @2-CCF5A568
...
//Prepare Method @2-FD43097B
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("2", "urlla_id", ccsText, "", "", $this->Parameters["urlla_id"], "", false);
        $this->wp->Criterion[1] = "( mfi_hvf2.cd_analysys_result like 'SAN%' )";
        $this->wp->Criterion[2] = $this->wp->Operation(opEqual, "mfi_hvf2.la_id", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
...
//Class_Initialize Event @567-BF7C50DD
    function clsRecordmfi_tc_individualcheck($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->mfi_mobile_status = new clsControl(ccsTextBox, "mfi_mobile_status", $CCSLocales->GetText("mfi_mobile_status"), ccsText, "", CCGetRequestParam("mfi_mobile_status", $Method, NULL), $this);
...
//CheckErrors Method @567-10B9BA71
...
//DataSource Variables @567-668577A0
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @567-C3D17398
    function clsmfi_tc_individualcheckDataSource(& $Parent)
    {
        ...
        $this->mfi_mobile_status = new clsField("mfi_mobile_status", ccsText, "");
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "tc_check_new_TMP1.html";
$BlockToParse = "main";
...
//Include events file @1-694D7B15
include_once("./tc_check_new_TMP1_events.php");
