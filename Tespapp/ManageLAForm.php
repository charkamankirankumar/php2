<?php
//Include Common Files @1-1067B50B
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "ManageLAForm.php");
...
//Operation Method @33-DBEAB5D8
    function Operation()
    {
        ...
        $Redirect = "ManageLAForm.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "ManageLAForm.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "ManageLAForm.html";
$BlockToParse = "main";
...
//Include events file @1-C3884280
include_once("./ManageLAForm_events.php");
