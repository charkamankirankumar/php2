<?php
//Include Common Files @1-34AAB245
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "KYC.php");
...
//Class_Initialize Event @7-F19B9ACA
...
//DataSourceClass_Initialize Event @7-2161706C
    function clsybl_kycDataSource(& $Parent)
    {
        ...
        $this->InsertFields["member_name_1"] = array("Name" => "member_name_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["rel_type_in_bor_kyc_1"] = array("Name" => "rel_type_in_bor_kyc_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["rel_name_in_bor_kyc_1"] = array("Name" => "rel_name_in_bor_kyc_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["member_age_1"] = array("Name" => "member_age_1", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["member_age_as_on_1"] = array("Name" => "member_age_as_on_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["date_of_birth_1"] = array("Name" => "date_of_birth_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["current_age_1"] = array("Name" => "current_age_1", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["member_address_1"] = array("Name" => "member_address_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["district_1"] = array("Name" => "district_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["pincode_1"] = array("Name" => "pincode_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["kyc_type_primary_1"] = array("Name" => "kyc_type_primary_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["guarantor_kyc_type_primery_1"] = array("Name" => "guarantor_kyc_type_primery_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["guarantor_kyc_id_secondry_1"] = array("Name" => "guarantor_kyc_id_secondry_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["guarantor_kyc_type_secondry_1"] = array("Name" => "guarantor_kyc_type_secondry_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["guarantor_kyc_id_primery_1"] = array("Name" => "guarantor_kyc_id_primery_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["kyc_id_primary_1"] = array("Name" => "kyc_id_primary_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["kyc_type_secondary_1"] = array("Name" => "kyc_type_secondary_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["kyc_id_secondary_1"] = array("Name" => "kyc_id_secondary_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["gurantor_age_1"] = array("Name" => "gurantor_age_1", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["gurantor_age_ason_1"] = array("Name" => "gurantor_age_ason_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["gurantor_dob_1"] = array("Name" => "gurantor_dob_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["gurantor_current_age_1"] = array("Name" => "gurantor_current_age_1", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["added_by_1"] = array("Name" => "added_by_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["added_at_1"] = array("Name" => "added_at_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["member_relation_type_1"] = array("Name" => "member_relation_type_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["relation_name_1"] = array("Name" => "relation_name_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        ...
        $this->UpdateFields["rel_type_in_bor_kyc_1"] = array("Name" => "rel_type_in_bor_kyc_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->UpdateFields["rel_name_in_bor_kyc_1"] = array("Name" => "rel_name_in_bor_kyc_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        ...
        $this->UpdateFields["pincode_1"] = array("Name" => "pincode_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        ...
        $this->UpdateFields["added_at_1"] = array("Name" => "added_at_1", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
...
//SetValues Method @7-F69C5C22
    function SetValues()
    {
        $this->la_id->SetDBValue($this->f("la_id"));
        $this->member_name_1->SetDBValue($this->f("member_name_1"));
        $this->member_relation_type->SetDBValue($this->f("rel_type_in_bor_kyc_1"));
        $this->relation_name_1->SetDBValue($this->f("rel_name_in_bor_kyc_1"));
        ...
        $this->ListBox1->SetDBValue($this->f("kyc_type_primary_1"));
        $this->ListBox2->SetDBValue($this->f("guarantor_kyc_type_primery_1"));
        $this->gurantor_kyc_secondry_id->SetDBValue($this->f("guarantor_kyc_id_secondry_1"));
        $this->ListBox3->SetDBValue($this->f("guarantor_kyc_type_secondry_1"));
        $this->gurantor_kyc_primary_id->SetDBValue($this->f("guarantor_kyc_id_primery_1"));
        $this->kyc_id_1->SetDBValue($this->f("kyc_id_primary_1"));
        $this->ListBox4->SetDBValue($this->f("kyc_type_secondary_1"));
        $this->secondary_kyc_id->SetDBValue($this->f("kyc_id_secondary_1"));
        $this->gurantor_age->SetDBValue(trim($this->f("gurantor_age_1")));
        $this->gurantor_age_as_on_1->SetDBValue($this->f("gurantor_age_ason_1"));
        $this->gurantor_dob->SetDBValue($this->f("gurantor_dob_1"));
        $this->gurantor_current_age->SetDBValue(trim($this->f("gurantor_current_age_1")));
        $this->added_by_1->SetDBValue($this->f("added_by_1"));
        $this->added_at_1->SetDBValue($this->f("added_at_1"));
        $this->member_relation_type1->SetDBValue($this->f("member_relation_type_1"));
        $this->relation_name_2->SetDBValue($this->f("relation_name_1"));
    }
//End SetValues Method

//Insert Method @7-D41B8344
    function Insert()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->InsertFields["member_name_1"]["Value"] = $this->member_name_1->GetDBValue(true);
        $this->InsertFields["rel_type_in_bor_kyc_1"]["Value"] = $this->member_relation_type->GetDBValue(true);
        $this->InsertFields["rel_name_in_bor_kyc_1"]["Value"] = $this->relation_name_1->GetDBValue(true);
        $this->InsertFields["member_age_1"]["Value"] = $this->member_age_1->GetDBValue(true);
        $this->InsertFields["member_age_as_on_1"]["Value"] = $this->member_age_as_on_1->GetDBValue(true);
        $this->InsertFields["date_of_birth_1"]["Value"] = $this->date_of_birth_1->GetDBValue(true);
        $this->InsertFields["current_age_1"]["Value"] = $this->current_age_1->GetDBValue(true);
        $this->InsertFields["member_address_1"]["Value"] = $this->member_address_1->GetDBValue(true);
        $this->InsertFields["district_1"]["Value"] = $this->district_1->GetDBValue(true);
        $this->InsertFields["pincode_1"]["Value"] = $this->pincode_1->GetDBValue(true);
        $this->InsertFields["kyc_type_primary_1"]["Value"] = $this->ListBox1->GetDBValue(true);
        $this->InsertFields["guarantor_kyc_type_primery_1"]["Value"] = $this->ListBox2->GetDBValue(true);
        $this->InsertFields["guarantor_kyc_id_secondry_1"]["Value"] = $this->gurantor_kyc_secondry_id->GetDBValue(true);
        $this->InsertFields["guarantor_kyc_type_secondry_1"]["Value"] = $this->ListBox3->GetDBValue(true);
        $this->InsertFields["guarantor_kyc_id_primery_1"]["Value"] = $this->gurantor_kyc_primary_id->GetDBValue(true);
        $this->InsertFields["kyc_id_primary_1"]["Value"] = $this->kyc_id_1->GetDBValue(true);
        $this->InsertFields["kyc_type_secondary_1"]["Value"] = $this->ListBox4->GetDBValue(true);
        $this->InsertFields["kyc_id_secondary_1"]["Value"] = $this->secondary_kyc_id->GetDBValue(true);
        $this->InsertFields["gurantor_age_1"]["Value"] = $this->gurantor_age->GetDBValue(true);
        $this->InsertFields["gurantor_age_ason_1"]["Value"] = $this->gurantor_age_as_on_1->GetDBValue(true);
        $this->InsertFields["gurantor_dob_1"]["Value"] = $this->gurantor_dob->GetDBValue(true);
        $this->InsertFields["gurantor_current_age_1"]["Value"] = $this->gurantor_current_age->GetDBValue(true);
        $this->InsertFields["added_by_1"]["Value"] = $this->added_by_1->GetDBValue(true);
        $this->InsertFields["added_at_1"]["Value"] = $this->added_at_1->GetDBValue(true);
        $this->InsertFields["member_relation_type_1"]["Value"] = $this->member_relation_type1->GetDBValue(true);
        $this->InsertFields["relation_name_1"]["Value"] = $this->relation_name_2->GetDBValue(true);
...
//Update Method @7-1A14F770
    function Update()
    {
        ...
        $this->UpdateFields["rel_type_in_bor_kyc_1"]["Value"] = $this->member_relation_type->GetDBValue(true);
        $this->UpdateFields["rel_name_in_bor_kyc_1"]["Value"] = $this->relation_name_1->GetDBValue(true);
        ...
        $this->UpdateFields["kyc_type_primary_1"]["Value"] = $this->ListBox1->GetDBValue(true);
        $this->UpdateFields["guarantor_kyc_type_primery_1"]["Value"] = $this->ListBox2->GetDBValue(true);
        $this->UpdateFields["guarantor_kyc_id_secondry_1"]["Value"] = $this->gurantor_kyc_secondry_id->GetDBValue(true);
        $this->UpdateFields["guarantor_kyc_type_secondry_1"]["Value"] = $this->ListBox3->GetDBValue(true);
        $this->UpdateFields["guarantor_kyc_id_primery_1"]["Value"] = $this->gurantor_kyc_primary_id->GetDBValue(true);
        $this->UpdateFields["kyc_id_primary_1"]["Value"] = $this->kyc_id_1->GetDBValue(true);
        $this->UpdateFields["kyc_type_secondary_1"]["Value"] = $this->ListBox4->GetDBValue(true);
        $this->UpdateFields["kyc_id_secondary_1"]["Value"] = $this->secondary_kyc_id->GetDBValue(true);
        $this->UpdateFields["gurantor_age_1"]["Value"] = $this->gurantor_age->GetDBValue(true);
        $this->UpdateFields["gurantor_age_ason_1"]["Value"] = $this->gurantor_age_as_on_1->GetDBValue(true);
        $this->UpdateFields["gurantor_dob_1"]["Value"] = $this->gurantor_dob->GetDBValue(true);
        $this->UpdateFields["gurantor_current_age_1"]["Value"] = $this->gurantor_current_age->GetDBValue(true);
        ...
        $this->UpdateFields["member_relation_type_1"]["Value"] = $this->member_relation_type1->GetDBValue(true);
        $this->UpdateFields["relation_name_1"]["Value"] = $this->relation_name_2->GetDBValue(true);
...
//Include events file @1-CC9CEA72
include_once("./KYC_events.php");
