...
//Page_BeforeInitialize @1-E5EB10A6
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $TC_DATA_REPORT_tmp; //Compatibility
...
//Page_AfterInitialize @1-DD467734
