<?php
//Include Common Files @1-91571508
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "DataUpdatePage.php");
...
//Initialize Method @29-E5CB8DE7
    function Initialize()
    {
        ...
        $this->DataSource->Parameters["urldoc_type"] = CCGetFromGet("doc_type", NULL);
    }
...
//Prepare Method @29-AFF1C9B0
    function Prepare()
    {
        ...
        $this->wp->AddParameter("2", "urldoc_type", ccsText, "", "", $this->Parameters["urldoc_type"], "", false);
        $this->AllParametersSet = $this->wp->AllParamsSet();
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "mfi_doc_territory_code", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->wp->Criterion[2] = $this->wp->Operation(opEqual, "mfi_doc_type", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "DataUpdatePage.html";
$BlockToParse = "main";
...
//Include events file @1-BAD6C86F
include_once("./DataUpdatePage_events.php");
...
$ListBox3->Values = array(array("CP", "Centre Proposal"), array("LA1", "LA FORM1"), array("LA2", "LA FORM 2"), array("INVALID IMAGE", "INVALID IMAGE"));
