<?php
//Include Common Files @1-A6A06FC8
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "KYC_DEDUP_ENTRY.php");
...
//Class_Initialize Event @29-AEF02550
    function clsRecordmfi_docs($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->mfi_doc_updatedon = new clsControl(ccsHidden, "mfi_doc_updatedon", "mfi_doc_updatedon", ccsText, "", CCGetRequestParam("mfi_doc_updatedon", $Method, NULL), $this);
            ...
            $this->ImageLink1->Page = "ChangeRegionBatchdedup.php";
            $this->doc_rejection_reason = new clsControl(ccsHidden, "doc_rejection_reason", "doc_rejection_reason", ccsText, "", CCGetRequestParam("doc_rejection_reason", $Method, NULL), $this);
        }
    }
//End Class_Initialize Event

//Initialize Method @29-B02DB530
    function Initialize()
    {
        ...
        $this->DataSource->Order = "batch_code, mfi_doc_code";
...
//DataSourceClass_Initialize Event @29-B48DA213
...
//Prepare Method @29-B2574E59
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = "( mfi_doc_status='DATA ENTERED' and mfi_doc_type='KYC' )";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "KYC_DEDUP_ENTRY.html";
$BlockToParse = "main";
...
//Include events file @1-D7DE79E3
include_once("./KYC_DEDUP_ENTRY_events.php");
...
$ListBox3->Values = array(array("CP", "Centre Proposal"), array("KYC", "KYC"), array("LA1", "LA Page 1"), array("LA2", "LA PAGE 2 "), array("ERROR-REJECTION", "ERROR-REJECTION"));
