<?php
//Include Common Files @1-A342F9EF
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "manageFileUpload_tmp.php");
...
//Class_Initialize Event @41-27F172F5
...
"FROM mfi_unit_regions {SQL_Where} {SQL_OrderBy}";
            ...
            $this->ListBox1->Values = array(array("New Form With Kyc", "New Form With Kyc"), array("New Form Without Kyc", "New Form Without Kyc"), array("RELOGIN", "RELOGIN"), array("DISB PHOTO", "DISB PHOTO"), array("EOD", "EOD"), array("OTHER", "OTHER"));
...
//CheckErrors Method @41-8C505437
...
//DataSource Variables @41-BAF1EE34
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @41-0057AA19
...
//Class_Initialize Event @15-9CC845E2
    function clsGridmfi_fileupload($RelativePath, & $Parent)
    {
        ...
        $this->mfi_territorycode->Page = "manageFileUpload_tmp.php";
        ...
        $this->mfi_fileupload_Insert->Page = "manageFileUpload_tmp.php";
...
//Operation Method @16-AC97E4AD
    function Operation()
    {
        ...
        $Redirect = "manageFileUpload_tmp.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "manageFileUpload_tmp.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "manageFileUpload_tmp.html";
$BlockToParse = "main";
...
//Include events file @1-990E5D2C
include_once("./manageFileUpload_tmp_events.php");
