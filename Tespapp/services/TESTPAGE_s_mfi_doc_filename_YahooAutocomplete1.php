<?php
//Include Common Files @1-C7119CC9
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "TESTPAGE_s_mfi_doc_filename_YahooAutocomplete1.php");
...
//Class_Initialize Event @2-E12193EE
...
//DataSource Variables @2-1A1765F4
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-EE608850
...
//Prepare Method @2-FF2B7672
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "mfi_doc_filename", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-003AC03E
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM mfi_docs";
        $this->SQL = "SELECT mfi_doc_filename \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "TESTPAGE_s_mfi_doc_filename_YahooAutocomplete1.html";
$BlockToParse = "main";
