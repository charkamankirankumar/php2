<?php
//Include Common Files @1-B5C576EE
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "ManageLAForm_s_mfi_hvf1_la_id_YahooAutocomplete1.php");
...
//Class_Initialize Event @2-E994B999
...
//DataSource Variables @2-AD3BAA9B
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-D60BCC13
...
//Prepare Method @2-DFA57A2C
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "mfi_hvf1_la_id", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-4CF099C8
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM mfi_hvf1";
        $this->SQL = "SELECT mfi_hvf1_la_id \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "ManageLAForm_s_mfi_hvf1_la_id_YahooAutocomplete1.html";
$BlockToParse = "main";
