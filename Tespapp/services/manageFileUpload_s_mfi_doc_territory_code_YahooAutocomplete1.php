<?php
//Include Common Files @1-874F912A
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "manageFileUpload_s_mfi_doc_territory_code_YahooAutocomplete1.php");
...
//Class_Initialize Event @2-7E3D6EA3
...
//DataSource Variables @2-87EC34E0
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-A8367E3F
...
//Prepare Method @2-FAD252A5
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "mfi_doc_territory_code", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-1552FC13
    function Open()
    {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "manageFileUpload_s_mfi_doc_territory_code_YahooAutocomplete1.html";
$BlockToParse = "main";
