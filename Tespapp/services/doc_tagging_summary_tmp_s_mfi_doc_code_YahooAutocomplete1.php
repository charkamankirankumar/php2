<?php
//Include Common Files @1-2202E929
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "doc_tagging_summary_tmp_s_mfi_doc_code_YahooAutocomplete1.php");
...
//Class_Initialize Event @2-2091FA08
    function clsGridmfi_docs1($RelativePath, & $Parent)
    {
        ...
        $this->mfi_doc_code = new clsControl(ccsLabel, "mfi_doc_code", "mfi_doc_code", ccsText, "", CCGetRequestParam("mfi_doc_code", ccsGet, NULL), $this);
    }
...
//DataSource Variables @2-C131790A
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-FDF8B1E1
...
//Prepare Method @2-90B1FC55
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "mfi_doc_code", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-A344AFA6
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM mfi_docs";
        $this->SQL = "SELECT mfi_doc_code \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "doc_tagging_summary_tmp_s_mfi_doc_code_YahooAutocomplete1.html";
$BlockToParse = "main";
