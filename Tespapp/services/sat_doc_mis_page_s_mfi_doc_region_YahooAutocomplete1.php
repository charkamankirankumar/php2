<?php
//Include Common Files @1-CB950861
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "sat_doc_mis_page_s_mfi_doc_region_YahooAutocomplete1.php");
...
//Class_Initialize Event @2-01F279A3
...
//DataSource Variables @2-DE6BAAC9
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-C3DCAB5E
...
//Prepare Method @2-41F55649
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "mfi_doc_region", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-B8ED35B5
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM mfi_docs";
        $this->SQL = "SELECT mfi_doc_region \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "sat_doc_mis_page_s_mfi_doc_region_YahooAutocomplete1.html";
$BlockToParse = "main";
