<?php
//Include Common Files @1-29AD6DCE
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "TESTPAGE_s_mfi_doc_status_YahooAutocomplete1.php");
...
//Class_Initialize Event @2-C4C76F38
...
//DataSource Variables @2-7378401B
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-597E63D9
...
//Prepare Method @2-FF6CB14B
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlquery", ccsInteger, "", "", $this->Parameters["urlquery"], "", false);
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "mfi_doc_status", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-3601D37D
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM mfi_docs";
        $this->SQL = "SELECT mfi_doc_status \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "TESTPAGE_s_mfi_doc_status_YahooAutocomplete1.html";
$BlockToParse = "main";
