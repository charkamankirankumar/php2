<?php
//Include Common Files @1-718E43D1
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "ManageLAForm_s_mfi_hvf1_gp_id_YahooAutocomplete1.php");
...
class clsGridmfi_hvf1 { //mfi_hvf1 class @2-8561444E
...
//Class_Initialize Event @2-19BDD631
...
//DataSource Variables @2-9A7CE46A
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-18A91B8C
...
//Prepare Method @2-FDB74E54
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "mfi_hvf1_gp_id", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-5E92F32F
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM mfi_hvf1";
        $this->SQL = "SELECT mfi_hvf1_gp_id \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "ManageLAForm_s_mfi_hvf1_gp_id_YahooAutocomplete1.html";
$BlockToParse = "main";
