<?php
//Include Common Files @1-7F1B50F9
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "TESTPAGE_s_mfi_doc_type_YahooAutocomplete1.php");
...
//Class_Initialize Event @2-2019B943
...
//DataSource Variables @2-7DAC3177
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-B4E8FFDD
...
//Prepare Method @2-13E29C9A
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "mfi_doc_type", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-075503DD
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM mfi_docs";
        $this->SQL = "SELECT mfi_doc_type \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "TESTPAGE_s_mfi_doc_type_YahooAutocomplete1.html";
$BlockToParse = "main";
