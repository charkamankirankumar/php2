<?php
//Include Common Files @1-7C3157A7
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "manageFileUpload_mfi_fileupload1_cp_id_PTAutoFill1.php");
...
class clsGridmfi_doc_upload { //mfi_doc_upload class @2-F8191E9D
...
//Class_Initialize Event @2-13364FD1
    function clsGridmfi_doc_upload($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        ...
        $this->ErrorBlock = "Grid mfi_doc_upload";
        ...
        $this->cp_name = new clsControl(ccsLabel, "cp_name", "cp_name", ccsText, "", CCGetRequestParam("cp_name", ccsGet, NULL), $this);
...
//GetErrors Method @2-E0EF635B
    function GetErrors()
    {
        $errors = "";
        $errors = ComposeStrings($errors, $this->cp_name->Errors->ToString());
...
//DataSource Variables @2-0073B851
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-A26F1C0E
...
//Open Method @2-2DA36CCF
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM mfi_doc_upload";
        $this->SQL = "SELECT cp_name, cp_id \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "manageFileUpload_mfi_fileupload1_cp_id_PTAutoFill1.html";
$BlockToParse = "main";
...
// Controls
$mfi_doc_upload = new clsGridmfi_doc_upload("", $MainPage);
...
//Go to destination page @1-C3AB9753
if($Redirect)
{
