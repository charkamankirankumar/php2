<?php
//Include Common Files @1-8B598076
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "sat_doc_mis_page_s_gp_code_YahooAutocomplete1.php");
...
//Class_Initialize Event @2-1D8F9813
    function clsGridmfi_doc_upload($RelativePath, & $Parent)
    {
        ...
        $this->gp_code = new clsControl(ccsLabel, "gp_code", "gp_code", ccsText, "", CCGetRequestParam("gp_code", ccsGet, NULL), $this);
    }
...
//DataSource Variables @2-B9D62189
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-67EF1774
...
//Prepare Method @2-70AE7666
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "gp_code", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-568B52F2
    function Open()
    {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "sat_doc_mis_page_s_gp_code_YahooAutocomplete1.html";
$BlockToParse = "main";
