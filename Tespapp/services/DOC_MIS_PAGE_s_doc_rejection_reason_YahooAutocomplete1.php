<?php
//Include Common Files @1-22B1B128
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "DOC_MIS_PAGE_s_doc_rejection_reason_YahooAutocomplete1.php");
...
//Class_Initialize Event @2-A72AFDA1
    function clsGridmfi_docs1($RelativePath, & $Parent)
    {
        ...
        $this->doc_rejection_reason = new clsControl(ccsLabel, "doc_rejection_reason", "doc_rejection_reason", ccsText, "", CCGetRequestParam("doc_rejection_reason", ccsGet, NULL), $this);
    }
...
//DataSource Variables @2-00927E50
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-925D9EC6
...
//Prepare Method @2-93E4B159
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "doc_rejection_reason", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-0C8CE247
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM mfi_docs";
        $this->SQL = "SELECT doc_rejection_reason \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "DOC_MIS_PAGE_s_doc_rejection_reason_YahooAutocomplete1.html";
$BlockToParse = "main";
