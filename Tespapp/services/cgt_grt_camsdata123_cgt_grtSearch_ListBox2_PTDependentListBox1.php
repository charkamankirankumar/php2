<?php
//Include Common Files @1-559712E8
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "cgt_grt_camsdata123_cgt_grtSearch_ListBox2_PTDependentListBox1.php");
...
//Class_Initialize Event @2-ED3ED997
...
//DataSource Variables @2-E7F169DD
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-85CAFA47
...
//Prepare Method @2-3F8B4BD9
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "ROUTE_CODE", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),true);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-B2F44D6B
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT BRANCH, CP_NO, concat(CP_NO,\" \",CENTER_NAME) AS Expr1 \n\n" .
        "FROM camsdata123_grid {SQL_Where}\n\n" .
        "GROUP BY CP_NO {SQL_OrderBy}";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "cgt_grt_camsdata123_cgt_grtSearch_ListBox2_PTDependentListBox1.html";
$BlockToParse = "main";
