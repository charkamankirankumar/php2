<?php
//Include Common Files @1-AC8B2487
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "cgt_grt_camsdata123_cgt_grtSearch_s_GP_NO_PTDependentListBox1.php");
...
//Prepare Method @2-166E42C7
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "CP_NO", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),true);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-E5B5B18E
    function Open()
    {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "cgt_grt_camsdata123_cgt_grtSearch_s_GP_NO_PTDependentListBox1.html";
$BlockToParse = "main";
