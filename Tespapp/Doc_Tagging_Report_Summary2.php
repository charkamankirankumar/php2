<?php
//Include Common Files @1-0B37D903
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Doc_Tagging_Report_Summary2.php");
...
//Operation Method @25-C28BB3BE
    function Operation()
    {
        ...
        $Redirect = "Doc_Tagging_Report_Summary2.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "Doc_Tagging_Report_Summary2.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Show Method @17-78657AE0
    function Show()
    {
        ...
        $this->DataSource->Parameters["urlbatch_code"] = CCGetFromGet("batch_code", NULL);
...
//Prepare Method @17-5A142747
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlbatch_code", ccsText, "", "", $this->Parameters["urlbatch_code"], "", false);
...
//Open Method @17-329871FA
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT batch_code, mfi_doc_type, mfi_doc_region, count(*) AS Expr1 \n\n" .
...
//Prepare Method @110-6D91DA87
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlmfi_doc_region", ccsText, "", "", $this->Parameters["urlmfi_doc_region"], "", false);
        $this->wp->AddParameter("2", "urls_batch_code", ccsText, "", "", $this->Parameters["urls_batch_code"], "", false);
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "mfi_doc_region", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->wp->Criterion[2] = $this->wp->Operation(opEqual, "mfi_docs.batch_code", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
        $this->wp->Criterion[3] = "( mfi_docs.mfi_doc_territory_code IS NOT NULL )";
        $this->wp->Criterion[4] = "( mfi_docs.mfi_doc_type='LA1' and mfi_docs.mfi_doc_status='DATA ENTERED' )";
        $this->wp->Criterion[5] = "( camsdata123_grid.`LA_NO` IS NULL )";
        $this->Where = $this->wp->opAND(
             false, $this->wp->opAND(
             false, $this->wp->opAND(
             false, $this->wp->opAND(
...
//Open Method @110-25CB61C2
    function Open()
    {
        ...
        "FROM mfi_docs,\n\n" .
        "camsdata123_grid {SQL_Where} {SQL_OrderBy}";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        if ($this->CountSQL) 
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Doc_Tagging_Report_Summary2.html";
$BlockToParse = "main";
...
//Include events file @1-1E1E341B
include_once("./Doc_Tagging_Report_Summary2_events.php");
...
$Sorter_batch_code;
$Sorter_la_id;
$Sorter_cb_analysys_result;
$Sorter_cd_analysys_result;
$Sorter_cb_approved_loan_amount;
$Sorter_mfi_telecaller_status;
$Sorter_final_result;
$mfi_docsSearch = new clsRecordmfi_docsSearch("", $MainPage);
$Report_Print = new clsControl(ccsLink, "Report_Print", "Report_Print", ccsText, "", CCGetRequestParam("Report_Print", ccsGet, NULL), $MainPage);
$Report_Print->Page = "Doc_Tagging_Report_Summary2.php";
...
$MainPage->Sorter_batch_code = $Sorter_batch_code = new clsSorter($ComponentName, "Sorter_batch_code", $FileName, $MainPage);
$MainPage->Sorter_la_id = $Sorter_la_id = new clsSorter($ComponentName, "Sorter_la_id", $FileName, $MainPage);
$MainPage->Sorter_cb_analysys_result = $Sorter_cb_analysys_result = new clsSorter($ComponentName, "Sorter_cb_analysys_result", $FileName, $MainPage);
$MainPage->Sorter_cd_analysys_result = $Sorter_cd_analysys_result = new clsSorter($ComponentName, "Sorter_cd_analysys_result", $FileName, $MainPage);
$MainPage->Sorter_cb_approved_loan_amount = $Sorter_cb_approved_loan_amount = new clsSorter($ComponentName, "Sorter_cb_approved_loan_amount", $FileName, $MainPage);
$MainPage->Sorter_mfi_telecaller_status = $Sorter_mfi_telecaller_status = new clsSorter($ComponentName, "Sorter_mfi_telecaller_status", $FileName, $MainPage);
$MainPage->Sorter_final_result = $Sorter_final_result = new clsSorter($ComponentName, "Sorter_final_result", $FileName, $MainPage);
$batch_code = new clsControl(ccsLabel, "batch_code", "batch_code", ccsText, "", CCGetRequestParam("batch_code", ccsGet, NULL), $MainPage);
$la_id = new clsControl(ccsLabel, "la_id", "la_id", ccsText, "", CCGetRequestParam("la_id", ccsGet, NULL), $MainPage);
$cb_analysys_result = new clsControl(ccsLabel, "cb_analysys_result", "cb_analysys_result", ccsText, "", CCGetRequestParam("cb_analysys_result", ccsGet, NULL), $MainPage);
$cd_analysys_result = new clsControl(ccsLabel, "cd_analysys_result", "cd_analysys_result", ccsText, "", CCGetRequestParam("cd_analysys_result", ccsGet, NULL), $MainPage);
$cb_approved_loan_amount = new clsControl(ccsLabel, "cb_approved_loan_amount", "cb_approved_loan_amount", ccsInteger, "", CCGetRequestParam("cb_approved_loan_amount", ccsGet, NULL), $MainPage);
$mfi_telecaller_status = new clsControl(ccsLabel, "mfi_telecaller_status", "mfi_telecaller_status", ccsText, "", CCGetRequestParam("mfi_telecaller_status", ccsGet, NULL), $MainPage);
$final_result = new clsControl(ccsLabel, "final_result", "final_result", ccsText, "", CCGetRequestParam("final_result", ccsGet, NULL), $MainPage);
$Navigator = new clsNavigator($ComponentName, "Navigator", $FileName, 10, tpSimple, $MainPage);
...
$MainPage->Sorter_batch_code = & $Sorter_batch_code;
$MainPage->Sorter_la_id = & $Sorter_la_id;
$MainPage->Sorter_cb_analysys_result = & $Sorter_cb_analysys_result;
$MainPage->Sorter_cd_analysys_result = & $Sorter_cd_analysys_result;
$MainPage->Sorter_cb_approved_loan_amount = & $Sorter_cb_approved_loan_amount;
$MainPage->Sorter_mfi_telecaller_status = & $Sorter_mfi_telecaller_status;
$MainPage->Sorter_final_result = & $Sorter_final_result;
$MainPage->batch_code = & $batch_code;
$MainPage->la_id = & $la_id;
$MainPage->cb_analysys_result = & $cb_analysys_result;
$MainPage->cd_analysys_result = & $cd_analysys_result;
$MainPage->cb_approved_loan_amount = & $cb_approved_loan_amount;
$MainPage->mfi_telecaller_status = & $mfi_telecaller_status;
$MainPage->final_result = & $final_result;
...
$Panel1->AddComponent("Sorter_batch_code", $Sorter_batch_code);
$Panel1->AddComponent("Sorter_la_id", $Sorter_la_id);
$Panel1->AddComponent("Sorter_cb_analysys_result", $Sorter_cb_analysys_result);
$Panel1->AddComponent("Sorter_cd_analysys_result", $Sorter_cd_analysys_result);
$Panel1->AddComponent("Sorter_cb_approved_loan_amount", $Sorter_cb_approved_loan_amount);
$Panel1->AddComponent("Sorter_mfi_telecaller_status", $Sorter_mfi_telecaller_status);
$Panel1->AddComponent("Sorter_final_result", $Sorter_final_result);
$Panel1->AddComponent("Navigator", $Navigator);
$Panel1->AddComponent("Label1", $Label1);
$Panel1->AddComponent("batch_code", $batch_code);
$Panel1->AddComponent("la_id", $la_id);
$Panel1->AddComponent("cb_analysys_result", $cb_analysys_result);
$Panel1->AddComponent("cd_analysys_result", $cd_analysys_result);
$Panel1->AddComponent("cb_approved_loan_amount", $cb_approved_loan_amount);
$Panel1->AddComponent("mfi_telecaller_status", $mfi_telecaller_status);
$Panel1->AddComponent("final_result", $final_result);
$Report_Print->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Report_Print->Parameters = CCAddParam($Report_Print->Parameters, "ViewMode", "Print");
$batch_code->SetValue($DataSource->batch_code->GetValue());
$la_id->SetValue($DataSource->la_id->GetValue());
$cb_analysys_result->SetValue($DataSource->cb_analysys_result->GetValue());
$cd_analysys_result->SetValue($DataSource->cd_analysys_result->GetValue());
$cb_approved_loan_amount->SetValue($DataSource->cb_approved_loan_amount->GetValue());
$mfi_telecaller_status->SetValue($DataSource->mfi_telecaller_status->GetValue());
$final_result->SetValue($DataSource->final_result->GetValue());
...
//Go to destination page @1-4F270968
if($Redirect)
{
